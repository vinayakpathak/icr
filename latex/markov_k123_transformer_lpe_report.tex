...
Equivalently,
\[
\log P_{\mathrm{TF}}(y_{1:m}\mid x_{1:n})
=\sum_{t=1}^{m}\log P_{\mathrm{model}}\!\left(y_t\mid x_{1:n},y_{1:t-1}\right).
\]
...
\midrule
p50 & $3.20\times 10^{3}$ & $5.20\times 10^{22}$ & 1.000000 \\
p90 & $8.72\times 10^{5}$ & $2.84\times 10^{33}$ & 1.000000 \\
p95 & $1.84\times 10^{6}$ & $6.16\times 10^{33}$ & 1.000000 \\
\bottomrule
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{../artifacts/markov\_k1\_gaplt1\_highcap\_lpeonly\_ctx1000\_roll1000\_detailed/figures/posterior\_vs\_naive\_percentiles\_k1\_teacher\_forcing.png}
\caption{Percentile-level comparison of posterior method error and naive-MC expected error (k=1, log scale).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{../artifacts/markov\_k1\_gaplt1\_highcap\_lpeonly\_ctx1000\_roll1000\_detailed/figures/relative\_error\_vs\_true\_prob\_k1\_teacher\_forcing.png}
...
With teacher-forced model probability as truth, the posterior method remains far better than equal-compute naive MC across percentiles (e.g., p50: \(3.20\times10^3\) vs \(5.20\times10^{22}\)), but its absolute errors are still large on difficult contexts.
